			...
			<Accordion defaultActiveKey={["0"]} alwaysOpen>
				<Accordion.Item eventKey="0">
					...
					<Accordion.Body>
						<h2>Langages</h2>
						<p>
							Appuyez sur un langage pour plus d'informations, et
							les framework connus!
						</p>
				...
				<Accordion.Item eventKey="1">
					...
					<Accordion.Body>
						<Row>
							<h2>Framework</h2>
							<p>
								Appuyez sur un framework pour plus
								d'informations!
							</p>
						</Row>
						<Row xs={1} md={5} className="g-4">
				...
				<Accordion.Item eventKey="3">
					...
					<Accordion.Body>
						<Row>
							<h2>Langues</h2>
							<p>Appuyez sur une langue pour voir le niveau!</p>
						</Row>
						<Row xs={1} md={5} className="g-4">
